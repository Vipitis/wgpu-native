// based on the main.c from triangle example and then trying to match mod.rs from ray_cube_fragment wgpu example.
#include "framework.h"
...
#define LOG_PREFIX "[ray_cube_fragment]"
...
int main(int argc, char *argv[]) {
  ...
  GLFWwindow *window =
      glfwCreateWindow(640, 480, "ray_cube_fragment [wgpu-native + glfw]", NULL, NULL);
  assert(window);
